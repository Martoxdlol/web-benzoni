...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    treatments: [
      ...
      { id: 'hifu', title: 'HIFU (Ultrasonido Focalizado de Alta Intensidad)', description: 'Esta tecnología estimula la producción de colágeno a nivel profundo, logrando un efecto lifting sin cirugía. Mejora la firmeza y redefine el óvalo facial con resultados graduales y naturales.', image: '/src/assets/images/services/facial/hifu.webp' },
      { id: 'fraxex', title: 'Fraxex', description: 'Radiofrecuencia Fraccionada. Favorece la regeneración de la piel mediante energía térmica controlada. Reduce poros, mejora textura, luminosidad y firmeza, promoviendo una renovación profunda y uniforme.', image: '/src/assets/images/services/facial/fraxex.jpg' },
