...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    treatments: [
      ...
      { id: 'fraxex', title: 'Fraxex', description: 'Radiofrecuencia Fraccionada. Favorece la regeneración de la piel mediante energía térmica controlada. Reduce poros, mejora textura, luminosidad y firmeza, promoviendo una renovación profunda y uniforme.', },
